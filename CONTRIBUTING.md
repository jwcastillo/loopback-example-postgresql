...
Thank you for your interest in `loopback-example-postgresql`, an open source project
administered by StrongLoop.

Contributing to `loopback-example-postgresql` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-example-postgresql)
